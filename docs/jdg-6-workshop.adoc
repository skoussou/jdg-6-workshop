...
The link:https://docs.jboss.org/infinispan/7.2/apidocs/[Cache]  is based on the following hierarchy (ConcurrentMap is not shown) image:images/CacheAPIHIerarchy.png["Cache Interfaces",height=128]
