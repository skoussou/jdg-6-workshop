...
link:https://docs.jboss.org/infinispan/7.2/apidocs/[Cache]:: Is the central interface of Infinispan. It is based on the following hierarchy (ConcurrentMap is not shown) image:images/CacheAPIHIerarchy.png["Cache Interfaces",height=128]
