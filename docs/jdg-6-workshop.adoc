...
The Cache is based on the following hierarchy (ConcurrentMap is not shown) image:images/CacheAPIHIerarchy.png["Cache Interfaces",height=128]
of interfaces and as with _CacheManger_ there are 2 types of Cache Interfaces (_Remote_, _Embedded_) which extend the _BasicCache_
...
----
link:https://docs.jboss.org/infinispan/7.2/apidocs/org/infinispan/AdvancedCache.html[AdvancedCache]:: 
link:https://docs.jboss.org/infinispan/7.2/apidocs/org/infinispan/security/SecureCache.html[SecureCache]:: 
